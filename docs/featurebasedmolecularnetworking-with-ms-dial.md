...
[Note] If you are processing with Waters MSe data, set MS method type to 'SWATH-MS or conventional All-ions method' and use [this experiment file](/img/ms-dial/MSe_experiment.txt).
