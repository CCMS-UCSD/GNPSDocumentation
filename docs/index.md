...
!!! note "GNPS For Industry"
	GNPS as a infrastructure is open for the academic community. If you are an industry user - please reach out to [Ming](mailto:mingxun.wang@cs.ucr.edu), [Pieter](mailto:pdorrestein@ucsd.edu), or the [UCSD Technology Transfer Office](mailto:innovation@ucsd.edu) to bring GNPS to your organization. 
