...
Open a ftp client such as [WinSCP](https://winscp.net/eng/download.php) client with the following input parameters; Host: massive-ftp.ucsd.edu followed by entering your user name and password for GNPS followed by enter.
